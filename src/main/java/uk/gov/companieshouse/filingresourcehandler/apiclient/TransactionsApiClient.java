...
public class TransactionsApiClient {
    ...
    private static final String GET_TRANSACTION_URI = "/private/%s";
    ...
    public Optional<Transaction> getTransaction(String transactionUrl) {
        ...
        try {
            String requestUri = GET_TRANSACTION_URI.formatted(transactionUrl);
            ...
            if (response.getStatusCode() != HttpStatus.OK.value()) {
                ...
                LOGGER.info("Successfully executed get transactions for transaction Url: %s".formatted(requestUri), DataMapHolder.getLogMap());
            }
