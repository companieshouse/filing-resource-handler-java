...
class TransactionsApiClientTest {
    ...
    void getTransactionReturnsTransactionOnSuccess() throws ApiErrorResponseException, URIValidationException, JsonProcessingException {
        ApiResponse<Transaction> apiResponse = new ApiResponse<>(HttpStatus.OK.value(), null, getTransactionRequestBody());
        ...
        assert (result.get().getId().equals(getTransactionRequestBody().getId()));
    }
